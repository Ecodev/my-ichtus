...
class AccountOperatorTypeTest extends OperatorType
{
    ...
    public static function providerGetDqlCondition(): iterable
    {
        ...
        yield 'Both: lines NOT affecting "Banque" account, neither credit or debit' => [7, [10025], true, false, AccountWhere::DebitOrCredit];
        ...
        yield 'Both: lines affecting ANY account (should be all lines)' => [13, [], true, false, AccountWhere::DebitOrCredit];
        ...
        yield 'Debit: lines NOT affecting "Banque" account' => [9, [10025], true, false, AccountWhere::Debit];
        yield 'Debit: lines NOT affecting any of those accounts' => [7, [10106, 10096], true, false, AccountWhere::Debit];
        yield 'Debit: lines NOT affecting any account' => [2, [], false, false, AccountWhere::Debit];
        yield 'Debit: lines affecting ANY account' => [11, [], true, false, AccountWhere::Debit];
        ...
        yield 'Credit: lines NOT affecting "Banque" account' => [10, [10025], true, false, AccountWhere::Credit];
        ...
        yield 'Credit: lines affecting ANY account' => [12, [], true, false, AccountWhere::Credit];
