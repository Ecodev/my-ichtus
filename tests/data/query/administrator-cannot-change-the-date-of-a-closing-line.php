...
return [
    [
        // Transaction 8005 is the accounting closing, whose lines keep the date of the closing
    ...
    [
        'errors' => [
            [
                'message' => 'Cannot modify transactionDate of a generated TransactionLine.',
                'extensions' => [
                    'showSnack' => true,
                ],
                'locations' => [
