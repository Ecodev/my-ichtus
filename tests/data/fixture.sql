...
REPLACE INTO bookable (id, image_id, credit_account_id, purchase_price, periodic_price, initial_price, is_active, name, code, booking_type, simultaneous_booking_maximum, description) VALUES
(3000, 5000, NULL, 30000, 0, 0, 1, 'Stand up S1 (3000, carnet de sortie, occupé)', 'S1', 'self_approved', 1, 'No, no, no, no. You gotta listen to the way people talk. You don''t say "affirmative," or some shit like that. You say "no problemo." And if someone comes on to you with an attitude you say "eat me." And if you want to shine them on it''s "hasta la vista, baby."'),
