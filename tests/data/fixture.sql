...
(3002, NULL, 10036, 0, 1000, 0, 'Casier virtuel (3002, sur demande, periodic)', 'casier', 'application', -1, 'Pour demande de stockage.'),
(3003, NULL, 10036, 0, 1000, 0, 'Casier 1012 (3003, inventaire / spécifique admin, periodic)', 'CA1012', 'admin_assigned', -1, 'Casier physique XYZ.'),
(3004, NULL, 10035, 0, 2000, 0, 'Membre NFT (3004, inventaire / spécifique admin, periodic)', 'e', 'application', -1, 'Service supplémentaire.'),
...
(3027, NULL, 10036, 0, 1000, 0, 'Armoire 1013 (3027, inventaire / spécifique admin, periodic)', 'A1013', 'admin_assigned', -1, 'Armoire physique XYZ.'),
(3028, NULL, 10036, 0, 1000, 0, 'Flotteur 1014 (3028, inventaire / spécifique admin, periodic)', 'F1014', 'admin_assigned', -1, 'Flotteur physique XYZ.'),
(3030, NULL, 10036, 0, 1000, 0, 'Armoire virtuelle (3030, sur demande, periodic)', 'armoire', 'application', -1, 'Pour demande de stockage.'),
(3031, NULL, 10036, 0, 1000, 0, 'Flotteur virtuel (3031, sur demande, periodic)', 'flotteur', 'application', -1, 'Pour demande de stockage.');
