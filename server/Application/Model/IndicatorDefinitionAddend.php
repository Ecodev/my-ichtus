...
/**
 * Addend account used in an accounting indicator formula.
 */
#[ORM\Entity]
class IndicatorDefinitionAddend extends AbstractModel
{
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    #[ORM\ManyToOne(targetEntity: IndicatorDefinition::class, inversedBy: 'addends')]
