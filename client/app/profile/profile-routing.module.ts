                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                data: {
                                    ...
                                    selectedColumns: ['name', 'description', 'price', 'createApplication'],
                                    availableColumns: ['name', 'description', 'price', 'createApplication'],
                            ...
                            },
                            {
                                ...
                                data: {
                                    ...
                                    selectedColumns: ['name', 'price', 'description', 'createApplication'],
                                    availableColumns: ['name', 'price', 'description', 'createApplication'],
                                    seo: {title: ''} as NaturalSeo,
                                },
                            },
                            {
                                ...
                                data: {
                                    ...
                                    selectedColumns: ['name', 'price', 'description', 'select'],
                                    availableColumns: ['name', 'price', 'description', 'select'],
                                    seo: {title: ''} as NaturalSeo,
                                },
                            },
                            {
