import {deleteElements, div} from '../general/home';
...
export function ableToSkipAnimation(): void {
...
export function animate(): void {
    ...
    let c: HTMLDivElement, w: HTMLDivElement, f: HTMLDivElement, r: HTMLDivElement;
...
function addSvgClass(elem: HTMLElement): void {
    if (document.documentElement.clientWidth < window.innerHeight) {
...
function newLetter(i: number): void {
    if (running) {
        ...
        d.style.backgroundImage = 'url(assets/navigations/logo/' + 'ichtus'[i] + '.svg)';
