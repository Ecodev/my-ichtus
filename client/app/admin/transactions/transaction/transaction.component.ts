    ...
    implements OnInit
{
    ...
    /**
     * Whether the transaction is an accounting closing, whose lines are all generated by the closing.
     * Absent on the creation page.
     */
    protected get isClosing(): boolean {
        return 'isClosing' in this.data.model && this.data.model.isClosing;
    }
